...
const experiences = [
  {
    ...
    type: "Freelance",
    description: "Building custom websites and web applications for clients focusing on professional Barbershop.",
    date: "2024",
  ...
  {
    id: 6,
    title: "Static Page Specialist",
    type: "Web Development",
    description: "Created high-converting static pages for various clients using modern web technologies.",
    date: "2024",
